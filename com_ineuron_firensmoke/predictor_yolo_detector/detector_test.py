...
from com_ineuron_firensmoke.predictor_yolo_detector.models.experimental import attempt_load
from com_ineuron_firensmoke.predictor_yolo_detector.utils.datasets import LoadStreams, LoadImages
from com_ineuron_firensmoke.predictor_yolo_detector.utils.general import (
    check_img_size, non_max_suppression, apply_classifier, scale_coords,
    xyxy2xywh, plot_one_box, strip_optimizer, set_logging)
from com_ineuron_firensmoke.predictor_yolo_detector.utils.torch_utils import select_device, load_classifier, \
    time_synchronized
...
class Detector():
    ...
    def __init__(self, filename):
        ...
        print(path)
        self.weights = "./com_ineuron_firensmoke/predictor_yolo_detector/best.pt"
        self.conf = float(0.5)
        self.source = "./com_ineuron_firensmoke/predictor_yolo_detector/inference/images/"
        self.img_size = int(416)
        self.save_dir = "./com_ineuron_firensmoke/predictor_yolo_detector/inference/output"
        self.view_img = False
        self.save_txt = False
        self.device = 'cpu'
        self.augment = True
